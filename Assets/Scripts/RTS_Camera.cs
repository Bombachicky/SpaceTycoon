...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float sensVert;
        public float panningSpeed = 10f;
        public float mouseRotationSpeed = 10f;
        public float xRotation;
        [SerializeField] public float lockVertMin;
        [SerializeField] public float lockVertMax;
        ...
        {
            float mouseY = Input.GetAxis("Mouse Y") * Time.deltaTime * rotationSped;

            // horizontal key rotation
